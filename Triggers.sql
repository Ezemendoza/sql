...
BEGIN
    ...
    (id_personal, campo, valor_anterior, valor_nuevo, nombre_actualizo, fecha_actualizado, hora_actualizado)
    VALUES
    (OLD.id_personal, 'sueldo', OLD.sueldo, NEW.sueldo, 'Trigger', CURDATE(), CURTIME());
END;
//
